...
{
  console.log('// ==================== Generating the Report on First case ========================\n');
    ...
    //const dropdown_templates = await page.locator('.rc-virtual-list-holder').nth(1);
     const dropdown_templates = await page.locator('//div[contains(@class, "ant-select-dropdown") and not(contains(@class, "ant-select-dropdown-hidden"))]');
   ...
   //Scroll to the bottom
    ...
    //Closing after downloaded the report
